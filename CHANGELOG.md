...
- Add a public v0 release-readiness path for Apple Agent Kit.
- Validate the repo as both a Codex plugin source and a Claude Code plugin source.
- Document local install, source checkout, validation, and private-adapter boundaries.
