...
4. The public tree has no filled adapters, private rollout boards, secrets, host details, or private device bindings.
...
`git ls-files docs/goals` should print nothing. GoalBuddy boards and filled rollout notes are useful working artifacts, but they should not be part of the public v0 plugin surface.
